 ...
 */
	public function testAutoLinkUrlsQueryString() {
		$text = 'Text with a partial http://www.cakephp.org?id_product=123&foo=bar link';
		$expected = 'Text with a partial <a href="http://www.cakephp.org?id_product=123&amp;foo=bar">http://www.cakephp.org?id_product=123&amp;foo=bar</a> link';
		$result = $this->Text->autoLinkUrls($text);
		$this->assertEquals($expected, $result);
	}
