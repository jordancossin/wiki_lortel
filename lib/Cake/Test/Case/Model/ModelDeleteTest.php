 ...
 */
	public function testDeleteArticleBLinks() {
		...
		$expected = array(
			array('ArticlesTag' => array('article_id' => '1', 'id_tag' => '1')),
			array('ArticlesTag' => array('article_id' => '1', 'id_tag' => '2')),
			array('ArticlesTag' => array('article_id' => '2', 'id_tag' => '1')),
			array('ArticlesTag' => array('article_id' => '2', 'id_tag' => '3'))
			);
		$this->assertEquals($expected, $result);
 ...
 */
	public function testDeleteHabtmPostgresFailure() {
		...
		// ERROR:
		// Postgresql: DELETE FROM "articles_tags" WHERE id_tag IN ('1', '3')
		// MySQL: DELETE `ArticlesTag` FROM `articles_tags` AS `ArticlesTag` WHERE `ArticlesTag`.`article_id` = 2 AND `ArticlesTag`.`id_tag` IN (1, 3)
